      ...
      <div class="header_bottom">
        ...
        <div class="container mt-5 mb-5">
            	<div class="card">
                        ...
                        <div class="d-flex flex-column justify-content-center">	<div class="main_image">
                            	<img src={p1} id="main_product_image" width="350"/>
                                	</div>	<div class="thumbnail_images">	
                                    <ul id="thumbnail">
                                        	<li><img onclick={changeImage} src={p1} width="70"/>
                                            </li>	
                                            <li><img onclick={changeImage} src={p2} width="70"/></li>	
                                            <li><img onclick={changeImage} src={p3} width="70"/></li>	<li>
                                                <img onclick={changeImage} src={p4} width="70"/>
                                                    </li>	</ul>	</div>	</div>	</div>	<div class="col-md-6">	<div class="p-3 right-side">
                                                        	<div class="d-flex justify-content-between align-items-center">	<h3>IIlana</h3>	
                                                            <span class="heart"><i class='bx bx-heart'></i></span>	</div>
             ...
             </div>	<i class='bx bx-share-alt share'>
                </i>
                	</div>	</div>	</div>	</div>
                    	</div> </div>
        </div>
