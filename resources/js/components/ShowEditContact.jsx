   ...
   {/*   bodyyyyy of the modal    */}
             ...
             <div className="mb-3">
              ...
              <div className="mb-3">
                  ...
                  <input disabled={type==="edit" ? false : true } onChange={(e)=>handleChange(e)} value={data.password} name="password" type="text"  className="form-control" />
              ...
              <div className="mb-3">
                  ...
                  <input disabled={type==="edit" ? false : true } onChange={(e)=>handleChange(e)} value={data.telephone} name="telephone" type="text" className="form-control" placeholder="Telephone" />
